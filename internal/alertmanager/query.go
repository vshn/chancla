...
type AlertmanagerReader interface {
	AlertsFromMatchers(ctx context.Context, matchers []string) (alertmanagermodels.GettableAlerts, error)
}
...
func (c *AlertmanagerClient) AlertsFromMatchers(ctx context.Context, matchers []string) (alertmanagermodels.GettableAlerts, error) {
	l := logrusr.New(log)
