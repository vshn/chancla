...
func init() {
	...
	utilruntime.Must(chanclavshniov1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgrOptions := ctrl.Options{
		...
		LeaderElectionID:       "0eb4960e.chancla.vshn.io",
	...
	if err := (&controller.RunbookReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "runbook")
		os.Exit(1)
	}
